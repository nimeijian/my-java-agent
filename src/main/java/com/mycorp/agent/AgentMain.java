                ...
                try {
                    ...
                    if (className.equals(TRANSFORM_CLASS)) {
                        ...
                        for (CtMethod method : clazz.getMethods()) {
                            ...
                            method.insertBefore(String.format("System.out.println(\"%s.%s start.\");", clazz.getSimpleName(), method.getName()));
                            method.insertAfter(String.format("System.out.println(\"%s.%s end.\");", clazz.getSimpleName(), method.getName()));
                        }
